...
namespace Health_System.Controllers
{
    public class HomeController : Controller
    {
        ...
        /// <summary>
        /// Extracts user-entered form data (optional fields) into a dictionary or object.
        /// </summary>
        private Dictionary<string, string> ExtractUserInputs(Microsoft.AspNetCore.Http.IFormCollection form)
        {
            // We store fields in a dictionary for flexible usage in prompt building
            var dict = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                ["weekWorkouts"] = form["weekWorkouts"],
            ...
            // You can do validation or trimming here as needed
            return dict;
        }

        /// <summary>
        /// Converts all uploaded files into Base64-encoded strings (done asynchronously).
        /// </summary>
        private async Task<List<string>> ConvertFilesToBase64Async(Microsoft.AspNetCore.Http.IFormFileCollection files)
        {
            ...
            List<string> base64Images)
        {
            ...
            if (option.Equals("videoHelp", StringComparison.OrdinalIgnoreCase))
            {
                ...
                string keywords = await CallOpenAiApiAsync(shortQueryPrompt, base64Images);

                // Step 2: Query YouTube
                var videoResults = await GetYouTubeVideosAsync(keywords);
